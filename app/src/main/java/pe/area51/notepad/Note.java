...
public class Note implements Parcelable {
    ...
    public Note(long localId, String remoteId, long creationUnixTime, long modificationUnixTime, String title, String content) {
    ...
    public String toString() {
        return "remoteId: " + remoteId +", localId: " + localId + ", creationUnixTime: " + creationUnixTime + ", modificationUnixTime: " + modificationUnixTime + ", Title: " + title + ", Content: " + content;
    }
